...
TEST_ERROR_MESSAGE_LOWERCASE = "test error"
...
def test_extra_fields_with_enum_and_dataclass():
    ...
    data = {
        ...
        "error": {"message": TEST_ERROR_MESSAGE_LOWERCASE},  # Should become dataclass
    ...
    assert model.error.message == TEST_ERROR_MESSAGE_LOWERCASE
    ...
    assert result["error"] == {"message": TEST_ERROR_MESSAGE_LOWERCASE}
...
def test_field_alias_in_as_dict():
    ...
    class ModelWithAliases(VersionedModel):
        ...
        user_email: str = field(
            default=TEST_EMAIL, metadata={'alias': 'email'})
