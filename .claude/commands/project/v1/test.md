...
1. **Python Syntax Check for rococo**
   - Preparation Command: None
   - Command: `find rococo -name "*.py" -type f -exec python -m py_compile {} +`
...
2. **All Unit Tests**
   ...
   - test_purpose: "Validates all functionality across models, repositories, and services"
...
[
  {
    "test_name": "python_syntax_check",
    "passed": false,
    "execution_command": "find rococo -name \"*.py\" -type f -exec python -m py_compile {} +",
    "test_purpose": "Validates Python syntax by compiling source files to bytecode, catching syntax errors like missing colons, invalid indentation, or malformed statements",
    "error": "SyntaxError: invalid syntax (models.py, line 42)"
  },
  {
    "test_name": "all_unit_tests",
    "passed": true,
    "execution_command": "python -m pytest tests/ -v --tb=short",
    "test_purpose": "Validates all functionality across models, repositories, and services"
  }
]
```